...
description: "2026年、生成AIの業務利用は多くの企業で「当たり前」になりつつあります。しかし、IPA（情報処理推進機構）の調査によれば、生成AIを業務利用している企業の約45%が、社内ガイドラインを「策定していない」または「策定中」の状態です。ガイドライン未策定のまま生成AIの利用が広がると、以下のリスクに直面します。"
---
