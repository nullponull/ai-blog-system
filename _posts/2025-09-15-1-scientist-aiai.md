...
*   **プライバシーとセキュリティを意識した設計:** オンデバイスAIの強みの一つはプライバシー保護です。これは、単にデータをクラウドに送らない、というだけでなく、差分プライバシーや連合学習といった技術を用いて、ユーザーデータを保護しながらAIを学習・利用する技術の需要が高まることを意味します。
...
この大きな変革の波の中で、私たち一人ひとりがAIとどう向き合い、その進化にどう貢献していくか。サムスンのAI戦略は、その問いに対する一つの力強い回答を示してくれたのではないでしょうか。
